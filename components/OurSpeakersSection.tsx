...
export const SPEAKERS_DATA: Speaker[] = [
  ...
  },
  {
    ...
    designation: "Lead Cryptographer & Security Consultant",
    description: "Expert in quantum-resistant encryption models and safe ledger protocols. Passionate about teaching cryptographic fundamentals to tomorrow's cybersecurity specialists.",
    experience: "8 years",
  ...
  },
  {
    ...
    description: "Vulnerability analysis specialist with an extensive history of network security assessments, zero-day threat intelligence, and red-team corporate simulations.",
    experience: "10 years",
